    ...
    try {
        ...
        for (let empIndex = 1; empIndex <= employeeCount; empIndex++) {
            ...
            try {
                ...
                const mappings = [
                    { target: 'M1',  source: { col: 1,  row: 0        }, type: 'month'               }, // A[B1]  -> B[M1]
                    { target: 'H5',  source: { col: 0,  row: rowIndex }                              }, // A[A]   -> B[H5]
                    { target: 'C8',  source: { col: 1,  row: rowIndex }                              }, // A[B]   -> B[C8]
                    { target: 'C6',  source: { col: 2,  row: rowIndex }                              }, // A[C]   -> B[C6]
                    { target: 'C5',  source: { col: 3,  row: rowIndex }                              }, // A[D]   -> B[C5]
                    { target: 'C7',  source: { col: 4,  row: rowIndex }                              }, // A[E]   -> B[C7]
                    { target: 'H8',  source: { col: 5,  row: rowIndex }, type: 'currency'            }, // A[F]   -> B[H8]
                    { target: 'H7',  source: { col: 6,  row: rowIndex }, type: 'currency'            }, // A[G]   -> B[H7]
                    { target: 'D11', source: { col: 7,  row: rowIndex }, type: 'days'                }, // A[H]   -> B[D11]
                    { target: 'E11', source: { col: 8,  row: rowIndex }, type: 'currency'            }, // A[I]   -> B[E11]
                    { target: 'D12', source: { col: 9,  row: rowIndex }, type: 'days'                }, // A[J]   -> B[D12]
                    { target: 'E12', source: { col: 10, row: rowIndex }, type: 'currency'            }, // A[K]   -> B[E12]
                    { target: 'D10', source: { col: 11, row: rowIndex }, type: 'days'                }, // A[L]   -> B[D10]
                    { target: 'E10', source: { col: 12, row: rowIndex }, type: 'currency'            }, // A[M]   -> B[E10]
                    { target: 'D13', source: { col: 13, row: rowIndex }, type: 'hours'               }, // A[N]   -> B[D13]
                    { target: 'E13', source: { col: 14, row: rowIndex }, type: 'currency'            }, // A[O]   -> B[E13]
                    { target: 'D14', source: { col: 15, row: rowIndex }, type: 'hours'               }, // A[P]   -> B[D14]
                    { target: 'E14', source: { col: 16, row: rowIndex }, type: 'currency'            }, // A[Q]   -> B[E14]
                    { target: 'D15', source: { col: 17, row: rowIndex }, type: 'hours'               }, // A[R]   -> B[D15]
                    { target: 'E15', source: { col: 18, row: rowIndex }, type: 'currency'            }, // A[S]   -> B[E15]
                    { target: 'D16', source: { col: 19, row: rowIndex }, type: 'days'                }, // A[T]   -> B[D16]
                    { target: 'E16', source: { col: 20, row: rowIndex }, type: 'currency'            }, // A[U]   -> B[E16]
                    { target: 'H13', source: { col: 21, row: rowIndex }, type: 'currency'            }, // A[V]   -> B[H13]
                    { target: 'H14', source: { col: 22, row: rowIndex }, type: 'currency'            }, // A[W]   -> B[H14]
                    { target: 'H15', source: { col: 23, row: rowIndex }, type: 'currency'            }, // A[X]   -> B[H15]
                    { target: 'H10', source: { col: 24, row: rowIndex }, type: 'currency'            }, // A[Y]   -> B[H10]
                    { target: 'H11', source: { col: 25, row: rowIndex }, type: 'currency'            }, // A[Z]   -> B[H11]
                    { target: 'H12', source: { col: 26, row: rowIndex }, type: 'currency'            }, // A[AA]  -> B[H12]
                    { target: 'D17', source: { col: 27, row: rowIndex }, type: 'days'                }, // A[AB]  -> B[D17]
                    { target: 'E17', source: { col: 28, row: rowIndex }, type: 'currency'            }, // A[AC]  -> B[E17]
                    { target: 'D19', source: { col: 29, row: rowIndex }, type: 'days'                }, // A[AD]  -> B[D19]
                    { target: 'E19', source: { col: 30, row: rowIndex }, type: 'currency'            }, // A[AE]  -> B[E19]
                    { target: 'H16', source: { col: 31, row: rowIndex }, type: 'currency'            }, // A[AF]  -> B[H16]
                    { target: 'H17', source: { col: 32, row: rowIndex }, type: 'currency'            }, // A[AG]  -> B[H17]
                    { target: 'H18', source: { col: 33, row: rowIndex }, type: 'currency'            }, // A[AH]  -> B[H18]
                    { target: 'H19', source: { col: 34, row: rowIndex }, type: 'currency'            }, // A[AI]  -> B[H19]
                    { target: 'H20', source: { col: 35, row: rowIndex }, type: 'currency'            }, // A[AJ]  -> B[H20]
                    { target: 'H21', source: { col: 36, row: rowIndex }, type: 'currency'            }, // A[AK]  -> B[H21]
                    { target: 'H22', source: { col: 37, row: rowIndex }, type: 'currency'            }, // A[AL]  -> B[H22]
                    { target: 'E18', source: { col: 38, row: rowIndex }, type: 'currency'            }, // A[AM]  -> B[E18]
                    { target: 'D20', source: { col: 39, row: rowIndex }, type: 'days'                }, // A[AN]  -> B[D20]
                    { target: 'D21', source: { col: 40, row: rowIndex }, type: 'days'                }, // A[AO]  -> B[D21]
                    { target: 'E21', source: { col: 41, row: rowIndex }, type: 'currency'            }, // A[AP]  -> B[E21]
                    { target: 'D22', source: { col: 42, row: rowIndex }, type: 'days'                }, // A[AQ]  -> B[D22]
                    { target: 'E22', source: { col: 43, row: rowIndex }, type: 'currency'            }, // A[AR]  -> B[E22]
                    { target: 'E23', source: { col: 44, row: rowIndex }, type: 'currency'            }, // A[AS]  -> B[E23]
                    { target: 'H28', source: { col: 45, row: rowIndex }                              }, // A[AT]  -> B[H28]
                    { target: 'H29', source: { col: 46, row: rowIndex }                              }, // A[AU]  -> B[H29]
                    { target: 'H30', source: { col: 47, row: rowIndex }, type: 'percentage'          }, // A[AV]  -> B[H30]
                    { target: 'H23', source: { col: 48, row: rowIndex }, type: 'currency'            }, // A[AW]  -> B[H23]
                    { target: 'E24', source: { col: 49, row: rowIndex }, type: 'currency'            }, // A[AX]  -> B[E24]
                    // A[AY] col 50 — skip
                    { target: 'E26', source: { col: 51, row: rowIndex }, type: 'currency_allow_zero' }, // A[AZ]  -> B[E26]
                    { target: 'E25', source: { col: 52, row: rowIndex }, type: 'currency'            }, // A[BA]  -> B[E25]
                    { target: 'H27', source: { col: 53, row: rowIndex }                              }, // A[BB]  -> B[H27]
                    { target: 'E27', source: { col: 54, row: rowIndex }, type: 'currency'            }, // A[BC]  -> B[E27]
                    { target: 'E28', source: { col: 55, row: rowIndex }, type: 'currency'            }, // A[BD]  -> B[E28]
                    { target: 'H25', source: { col: 56, row: rowIndex }, type: 'currency'            }, // A[BE]  -> B[H25]
                    { target: 'H26', source: { col: 57, row: rowIndex }, type: 'currency_allow_zero' }, // A[BF]  -> B[H26]
                    { target: 'E29', source: { col: 58, row: rowIndex }, type: 'currency'            }, // A[BG]  -> B[E29]
                    { target: 'E30', source: { col: 59, row: rowIndex }, type: 'currency'            }, // A[BH]  -> B[E30]
                ];
                ...
                mappings.forEach(mapping => {
                    ...
                    if (mapping.type === 'month') {
                        // Normalize month/year format, ensuring exactly one space around the slash
                        // e.g. "Tháng 02 /2026" → "Tháng 02 / 2026"
                        finalValue = String(sourceValue).replace(/\s*\/\s*/, ' / ').trim();
